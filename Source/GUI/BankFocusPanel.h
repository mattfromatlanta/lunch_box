...
private:
    ...
    juce::TextButton sortButton     { "Sort A-Z" };
    juce::TextButton autoFillButton { "Auto-Fill" };
    juce::TextButton clearButton    { "Clear Bank" };
    ...
    int  dragInsertIdx   = -1;   // row index where insertion line is shown
    bool isDragging      = false;

    static constexpr int BANK_COL_WIDTH  = 36;
    static constexpr int ACTION_ROW_H    = 28;
